...
func CacheGetRandomSatisfiedChannel(param *RetryParam) (*model.Channel, string, error) {
	...
	if param.TokenGroup == "auto" {
		...
		for i := startGroupIndex; i < len(autoGroups); i++ {
			...
			channel, err = model.GetRandomSatisfiedChannelWithFiltersAndExclusions(autoGroup, param.ModelName, priorityRetry, filters, mergedExcluded)
		...
		channel, err = model.GetRandomSatisfiedChannelWithFiltersAndExclusions(param.TokenGroup, param.ModelName, param.GetRetry(), filters, mergedExcluded)
