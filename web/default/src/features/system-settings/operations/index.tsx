...
const defaultOperationsSettings: OperationsSettings = {
  ...
  'general_setting.ignore_cached_tokens_after_affinity_switch': false,
  ...
  'monitor_setting.auto_priority_scan_enabled': false,
  'monitor_setting.auto_priority_scan_interval_hours': 6,
  SMTPServer: '',
  SMTPPort: '',
  SMTPAccount: '',
  SMTPFrom: '',
