...
export const STATIC_I18N_KEYS = [
  ...
  'Production relay at laiber.cloud',
  'laiber.cloud AI API Relay',
  'qianshan SSH',
  'Docker first',
  'Metered access',
  'provider routes ready',
  'OpenAI-compatible base URL',
  'usage and cost visibility',
  'Docker redeploy path',
  'One endpoint for every app',
  'Key isolation and quotas',
  'Operational clarity',
  ...
  'Somewhere between models and people,',
  'there should be a quieter harbor.',
  'Laiber AI',
  'Enter Console',
  'Create account',
  'Model pricing',
  ...
  'Current node is not master, so scheduled scans do not run here.',
  'Background auto priority scan is disabled.',
  'Scheduled scans are active on this node.',
  'Node: {{nodeType}}',
  'Running',
  'Run once',
  'Auto priority scan finished: scanned {{scanned}}, applied {{applied}}',
  'Failed to run auto priority scan',
  'Auto priority scan is already running',
